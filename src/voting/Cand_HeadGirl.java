 ...
 * @author Luqmaan
 */
public class Cand_HeadGirl extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public Cand_HeadGirl() {
        initComponents();
    ...
    public Cand_HeadGirl(String check) {
        initComponents();
        jLabel1.setIcon(Voting.small);
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        ...
        while (times == 0) {
            try {
                ...
                /*String query = "Select *from headgirl order by pos;";
                ...
                String query = "Select *from headgirl where pos = 1;";
            ...
            try {
                ...
                query = "Select *from headgirl where pos = 2;";
            ...
            try {
                ...
                query = "Select *from headgirl where pos = 3;";
            ...
            try {
                ...
                query = "Select *from headgirl where pos = 4;";
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            if (path != null) {
                ...
                try {
                    ...
                    String query = "Select path from headgirl where pos = " + pos + ";";

                    rs = stmt.executeQuery(query);

                    if (rs.next() != true) {
                        query = "insert into headgirl (count, path, pos) values (0, '" + path.toString() + "'," + pos + ");";
                        stmt.executeUpdate(query);
                    } else {
                        query = "update headgirl set path = '" + path.toString() + "' where pos = " + pos + ";";
                        stmt.executeUpdate(query);
                    }
    ...
    private void Cand1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Cand1KeyReleased
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            try {
                ...
                String query = "Select name from headgirl where pos = " + pos + ";";
                ...
                if (rs.next() != true) {
                    query = "insert into headgirl (name, count, pos) values ('" + name.toUpperCase() + "', 0, " + pos + ");";

                    stmt.executeUpdate(query);
                } else {
                    query = "update headgirl set name = '" + name.toUpperCase() + "' where pos = " + pos + ";";
                    stmt.executeUpdate(query);
                }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try {
            ...
            String query = "Delete from headgirl where pos = " + pos + ";";

            stmt.executeUpdate(query);

            pic1.setIcon(null);
            pic1.setText("ADD IMAGE");
            Cand1.setText("HEAD GIRL " + pos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cand_HeadGirl.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Cand_HeadGirl head = new Cand_HeadGirl();
