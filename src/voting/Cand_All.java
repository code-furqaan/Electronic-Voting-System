 ...
 * @author Luqmaan
 */
public class Cand_All extends javax.swing.JFrame {
    ...
    public Cand_All() {
        ...
        try {
            ...
            String query1 = "Select * from headboy order by(name);;";
        ...
        try {
            ImageIcon headboy1 = new ImageIcon(LheadboyImage.get(0).toString());
    ...
    public static ArrayList LheadboyImage = new ArrayList();
    public static ArrayList LheadgirlImage = new ArrayList();
    public static ArrayList LculturalImage = new ArrayList();
    public static ArrayList LsportsImage = new ArrayList();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cand_All.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
