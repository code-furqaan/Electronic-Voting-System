 ...
 * @author Luqmaan
 */
public class Cand_Sports extends javax.swing.JFrame {
    ...
    public Cand_Sports(String check) {
        initComponents();
        jLabel1.setIcon(Voting.small);
    ...
    private void initComponents() {
        ...
        Cand2.setText("SPORTS CAPTAIN 2");
        ...
        Cand3.setText("SPORTS CAPTAIN 3");
        ...
        Cand4.setText("SPORTS CAPTAIN 4");
        ...
        Cand1.setText("SPORTS CAPTAIN 1");
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        ...
        while (times == 0) {
            try {
                ...
                /*String query = "Select *from sports order by pos;";
                ...
                String query = "Select *from sports where pos = 1;";
            ...
            try {
                ...
                query = "Select *from sports where pos = 2;";
            ...
            try {
                ...
                query = "Select *from sports where pos = 3;";
            ...
            try {
                ...
                query = "Select *from sports where pos = 4;";
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            if (path != null) {
                ...
                try {
                    ...
                    String query = "Select path from sports where pos = " + pos + ";";

                    rs = stmt.executeQuery(query);

                    if (rs.next() != true) {
                        query = "insert into sports (count, path, pos) values (0, '" + path.toString() + "'," + pos + ");";
                        stmt.executeUpdate(query);
                    } else {
                        query = "update sports set path = '" + path.toString() + "' where pos = " + pos + ";";
                        stmt.executeUpdate(query);
                    }
    ...
    private void Cand1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Cand1KeyReleased
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            try {
                ...
                String query = "Select name from sports where pos = " + pos + ";";
                ...
                if (rs.next() != true) {
                    query = "insert into sports (name, count, pos) values ('" + name.toUpperCase() + "', 0, " + pos + ");";

                    stmt.executeUpdate(query);
                } else {
                    query = "update sports set name = '" + name.toUpperCase() + "' where pos = " + pos + ";";
                    stmt.executeUpdate(query);
                }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try {
            ...
            String query = "Delete from sports where pos = " + pos + ";";

            stmt.executeUpdate(query);

            pic1.setIcon(null);
            pic1.setText("ADD IMAGE");
            Cand1.setText("SPORTS CAPTAIN " + pos);
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        try {
            ...
            pic3.setIcon(null);
            pic3.setText("ADD IMAGE");
            Cand3.setText("SPORTS CAPTAIN " + pos);
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        try {
            ...
            pic2.setIcon(null);
            pic2.setText("ADD IMAGE");
            Cand2.setText("SPORTS CAPTAIN " + pos);
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        try {
            ...
            pic4.setIcon(null);
            pic4.setText("ADD IMAGE");
            Cand4.setText("SPORTS CAPTAIN " + pos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cand_Sports.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Cand_Sports head = new Cand_Sports();
